Public Class cls_Supplier_Invoice_Settlement_prop
...
Public Class cls_Supplier_Invoice_Settlement
    Inherits CommonClass

    Public Sub insert_Invoice_Settlement(ByVal clsObj As cls_Supplier_Invoice_Settlement_prop)
        ...
        cmd.CommandText = "ProcSupplierPaymentTransaction_Insert"
    ...
    Public Sub Update_Payment_Status(ByVal clsObj As cls_Supplier_Invoice_Settlement_prop)
        ...
        End If
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Proc_SupplierUpdatePaymentStauts"
    ...
    Public Sub Update_Undistributed_Amount(ByVal clsObj As cls_Supplier_Invoice_Settlement_prop)
        ...
        End If
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Proc_SupplierSettlementDetail_Insert"
        cmd.Parameters.AddWithValue("@PaymentTransactionId", clsObj.PaymentTransactionId)
        cmd.Parameters.AddWithValue("@PaymentId", clsObj.PaymentId)
        cmd.Parameters.AddWithValue("@MrnNo", clsObj.MrnNo)
