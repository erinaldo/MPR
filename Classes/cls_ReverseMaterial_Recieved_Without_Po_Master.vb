...
Namespace ReverseMaterial_Recieved_Without_Po_Master


    Public Class cls_ReverseMaterial_Recieved_Without_Po_Master_Prop
        ...
        Public Property Prev_Item_Qty() As Decimal
            Get
        ...
        Public Property Prev_Item_Rate() As Decimal
            Get
        ...
        Public Property Prev_Item_vat() As Decimal
            Get
        ...
        Public Property Prev_Item_exice() As Decimal
            Get
        ...
        Public Property Item_vat() As Decimal
            Get
                Item_vat = _Item_vat
            End Get
            Set(ByVal value As Decimal)
        ...
        Public Property Item_exice() As Decimal
            Get
        ...
        Public Property MRNId() As Double
            ...
            End Set
        End Property
        Public Property CostCenter_ID() As Double
            Get
    ...
    Public Class cls_ReverseMaterial_Recieved_Without_Po_Master
        Inherits CommonClass
        Public Sub insert_ReverseMATERIAL_RECIEVED_WITHOUT_PO_MASTER(ByVal clsObj As cls_ReverseMaterial_Recieved_Without_Po_Master_Prop, ByVal cmd As SqlCommand)

            ' cmd = New SqlClient.SqlCommand
            ' cmd.Connection = con
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "PROC_ReverseMATERIAL_RECIEVED_WITHOUT_PO_MASTER"
        ...
        End Sub
        Public Sub insert_ReverseMATERIAL_RECIEVED_WITHOUT_PO_Detail(ByVal clsObj As cls_ReverseMaterial_Recieved_Without_Po_Master_Prop, ByVal cmd As SqlCommand)

            ' cmd = New SqlClient.SqlCommand
            ' cmd.Connection = con
            cmd.Parameters.Clear()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "PROC_REVERSEMATERIAL_RECEIVED_WITHOUT_PO_DETAIL"
        ...
        Public Sub insert_ReverseNON_STOCKABLE_MATERIAL_RECIEVED_WITHOUT_PO(ByVal clsObj As cls_ReverseMaterial_Recieved_Without_Po_Master_Prop, ByVal cmd As SqlCommand)

            ' cmd = New SqlClient.SqlCommand
            ' cmd.Connection = con
            cmd.Parameters.Clear()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "PROC_REVERSE_NON_STOCKABLE_MATERIAL_RECEIVED_WITHOUT_PO"
        ...
        Public Sub update_ReverseMATERIAL_RECIEVED_WITHOUT_PO_MASTER(ByVal clsObj As cls_ReverseMaterial_Recieved_Without_Po_Master_Prop)
        ...
        Public Sub delete_ReverseMATERIAL_RECIEVED_WITHOUT_PO_MASTER(ByVal clsObj As cls_ReverseMaterial_Recieved_Without_Po_Master_Prop)
