...
Namespace wastage_master_cc
    Public Class cls_wastage_master_prop_cc
    ...
    Public Class cls_wastage_master_cc
        Inherits CommonClass

        Public Function Insert_Wastage_MasterTran(ByVal clsObj As cls_wastage_master_prop_cc) As String
            ...
            Try
                ...
                cmd.CommandText = "PROC_WASTAGE_MASTER_CC"
                ...
                cmd.Parameters.AddWithValue("@V_Division_ID", clsObj.CostCenter_ID)
                ...
                For iRow = 0 To dt.Rows.Count - 1
                    ...
                    If Convert.ToDouble(dt.Rows(iRow)("Wastage_Qty") > 0.0) Then
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.CommandText = "PROC_WASTAGE_DETAIL_CC"
                        cmd.Parameters.AddWithValue("@V_Wastage_ID", clsObj.Wastage_ID)
        ...
        Public Sub Insert_Wastage_Master(ByVal clsObj As cls_wastage_master_prop_cc, ByVal cmd As SqlCommand)
            cmd.Parameters.Clear()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "PROC_WASTAGE_MASTER_CC"
            cmd.Parameters.AddWithValue("@V_Wastage_ID", clsObj.Wastage_ID)
        ...
        Public Sub Insert_Wastage_Detail(ByVal clsObj As cls_wastage_master_prop_cc, ByVal cmd As SqlCommand)
            cmd.Parameters.Clear()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "PROC_WASTAGE_DETAIL_CC"
            cmd.Parameters.AddWithValue("@V_Wastage_ID", clsObj.Wastage_ID)
            ...
            cmd.Parameters.AddWithValue("@v_Balance_Qty", clsObj.Balance_Qty)
            cmd.Parameters.AddWithValue("@V_Created_By", clsObj.Created_BY)
            cmd.Parameters.AddWithValue("@V_Creation_Date", clsObj.Creation_Date)
            cmd.Parameters.AddWithValue("@V_Modified_By", clsObj.Modified_BY)
            cmd.Parameters.AddWithValue("@V_Modified_Date", clsObj.Modified_Date)
        ...
        Public Sub Update_Wastage_Master(ByVal clsObj As cls_wastage_master_prop_cc, ByVal cmd As SqlCommand)
            cmd.Parameters.Clear()
            cmd.CommandType = CommandType.StoredProcedure
        ...
        Public Sub Delete_WASTAGE_MASTER(ByVal clsObj As cls_wastage_master_prop_cc, ByVal cmd As SqlCommand)
            cmd.Parameters.Clear()
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "PROC_WASTAGE_MASTER"
            cmd.Parameters.AddWithValue("@V_Wastage_ID", clsObj.Wastage_ID)
        ...
        Public Sub Delete_Wastage_Detail(ByVal clsObj As cls_wastage_master_prop_cc, ByVal cmd As SqlCommand)
            cmd.Parameters.Clear()
            cmd.CommandType = CommandType.StoredProcedure
        ...
        Public Sub GET_WASTAGE_MASTER(ByVal clsObj As cls_wastage_master_prop_cc)
