...
Public Class cry_Tax_Invoice_
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cry_Tax_Invoice .rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PaymentTransactionId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcry_Tax_Invoice_
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cry_Tax_Invoice_ = New cry_Tax_Invoice_()
        rpt.Site = Me.Site
        Return rpt
    End Function
