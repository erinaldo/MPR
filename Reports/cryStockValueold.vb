...
Public Class cryStockValueold
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryStockValueold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryStockValueold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryStockValueold = New cryStockValueold()
        rpt.Site = Me.Site
        Return rpt
    End Function
