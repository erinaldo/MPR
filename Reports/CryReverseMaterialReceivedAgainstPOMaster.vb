...
Public Class CryReverseMaterialReceivedAgainstPOMaster
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryReverseMaterialReceivedAgainstPOMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.CryReverseMaterialReceivedAgainstPOMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Reverse_ID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCryReverseMaterialReceivedAgainstPOMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryReverseMaterialReceivedAgainstPOMaster = New CryReverseMaterialReceivedAgainstPOMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
