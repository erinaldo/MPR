...
Public Class cryWastagePrint_cc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryWastagePrint_cc.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_wastage_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryWastagePrint_cc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryWastagePrint_cc = New cryWastagePrint_cc()
        rpt.Site = Me.Site
        Return rpt
    End Function
