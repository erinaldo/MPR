...
Public Class cryStockTransferCCPrint
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryStockTransferCCPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryStockTransferCCPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TRANSFER_ID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryStockTransferCCPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryStockTransferCCPrint = New cryStockTransferCCPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
