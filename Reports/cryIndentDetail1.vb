...
Public Class cryIndentDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryIndentDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryIndentDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryIndentDetail = New cryIndentDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
