...
Public Class cryMaterialIssueCostCenterPrint
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryMaterialIssueCostCenterPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryMaterialIssueCostCenterPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_mio_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryMaterialIssueCostCenterPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryMaterialIssueCostCenterPrint = New cryMaterialIssueCostCenterPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
