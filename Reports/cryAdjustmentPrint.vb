...
Public Class cryAdjustmentPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryAdjustmentPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Adjustment_id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcryAdjustmentPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryAdjustmentPrint = New cryAdjustmentPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
