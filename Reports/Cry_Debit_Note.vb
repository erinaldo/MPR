...
Public Class Cry_Debit_Note
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.Cry_Debit_Note.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Debit_Note
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Debit_Note = New Cry_Debit_Note()
        rpt.Site = Me.Site
        Return rpt
    End Function
