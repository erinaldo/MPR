...
Public Class cryIKT_ItemWise_cc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryIKT_ItemWise_cc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryIKT_ItemWise_cc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryIKT_ItemWise_cc = New cryIKT_ItemWise_cc()
        rpt.Site = Me.Site
        Return rpt
    End Function
