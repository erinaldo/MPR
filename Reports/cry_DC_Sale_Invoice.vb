...
Public Class cry_DC_Sale_Invoice
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cry_DC_Sale_Invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cry_DC_Sale_Invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcry_DC_Sale_Invoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cry_DC_Sale_Invoice = New cry_DC_Sale_Invoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
