...
Public Class cryMrsItemMStore
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryMrsItemMStore.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryMrsItemMStore
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryMrsItemMStore = New cryMrsItemMStore()
        rpt.Site = Me.Site
        Return rpt
    End Function
