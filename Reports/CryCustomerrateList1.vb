...
Public Class CryCustomerrateList
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryCustomerrateList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.CryCustomerrateList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SRL_ID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCryCustomerrateList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryCustomerrateList = New CryCustomerrateList()
        rpt.Site = Me.Site
        Return rpt
    End Function
