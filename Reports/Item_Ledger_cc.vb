...
Public Class Item_Ledger_cc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.Item_Ledger_cc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItem_Ledger_cc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Item_Ledger_cc = New Item_Ledger_cc()
        rpt.Site = Me.Site
        Return rpt
    End Function
