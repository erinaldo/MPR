...
Public Class Cry_Credit_Note
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.Cry_Credit_Note.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_Credit_Note
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_Credit_Note = New Cry_Credit_Note()
        rpt.Site = Me.Site
        Return rpt
    End Function
