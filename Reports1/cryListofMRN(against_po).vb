...
Public Class cryListofMRNagainst_po
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryListofMRN(against_po).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryListofMRN(against_po).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListofMRNagainst_po
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListofMRNagainst_po = New cryListofMRNagainst_po()
        rpt.Site = Me.Site
        Return rpt
    End Function
