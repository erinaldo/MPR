...
Public Class cryStockValue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryStockValue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryStockValue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryStockValue = New cryStockValue()
        rpt.Site = Me.Site
        Return rpt
    End Function
