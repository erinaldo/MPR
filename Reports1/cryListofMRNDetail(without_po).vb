...
Public Class cryListofMRNDetailwithout_po
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryListofMRNDetail(without_po).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryListofMRNDetail(without_po).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListofMRNDetailwithout_po
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListofMRNDetailwithout_po = New cryListofMRNDetailwithout_po()
        rpt.Site = Me.Site
        Return rpt
    End Function
