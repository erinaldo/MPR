...
Public Class cryAllPurchaserates
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cryAllPurchaserates.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryAllPurchaserates.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryAllPurchaserates
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryAllPurchaserates = New cryAllPurchaserates()
        rpt.Site = Me.Site
        Return rpt
    End Function
