...
Public Class cryListofIndent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.cryListofIndent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryListofIndent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryListofIndent = New cryListofIndent()
        rpt.Site = Me.Site
        Return rpt
    End Function
