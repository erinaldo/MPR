...
Public Class crySaleInvoiceList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.crySaleInvoiceList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrySaleInvoiceList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crySaleInvoiceList = New crySaleInvoiceList()
        rpt.Site = Me.Site
        Return rpt
    End Function
