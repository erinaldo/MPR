...
Public Class frm_CreditorsOS
    ...
    Public Sub ReportOS()
        ...
        filepath = ReportFilePath & "cry_CreditorOutstanding.rpt"
        'End If
        rep.Load(filepath)
    ...
    Public Sub ViewClick(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.ViewClick
        ...
        End Try
    End Sub
    Private Sub CreditorsOS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CustomerBind()
    End Sub
