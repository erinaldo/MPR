...
Public Class frm_CashBook
    ...
    Public Sub CustomerBind()
        clsObj.ComboBind(cmbSupplier, "Select ACC_ID,ACC_NAME FROM dbo.ACCOUNT_MASTER WHERE AG_ID In(3,6) Order by ACC_NAME", "ACC_NAME", "ACC_ID", True)
    End Sub

    Public Sub ReportOS()
        Dim filepath As String = ""
        Dim rep As New ReportDocument()
        filepath = ReportFilePath & "CryCashBook.rpt"
        ...
        rep.SetParameterValue("Fromdate", txtFromDate.Value.Date.ToString("dd-MMM-yyyy"))
        rep.SetParameterValue("Todate", txtTodate.Value.Date.ToString("dd-MMM-yyyy"))
    ...
    Private Sub frm_CashBook_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CustomerBind()
    End Sub
