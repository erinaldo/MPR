...
Public Class CryDebtorsLedger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MMSPlus.CryDebtorsLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryDebtorsLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryDebtorsLedger = New CryDebtorsLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function
