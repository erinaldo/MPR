    ...
    Private Sub geItemDetail(ByVal ItemID As Integer)
        Try
            ...
            Qry = "SELECT UNIT_MASTER.UM_ID, UNIT_MASTER.UM_Name, ITEM_CATEGORY.ITEM_CAT_ID, ITEM_CATEGORY.ITEM_CAT_NAME, ITEM_MASTER.ITEM_ID, " _
                    ...
                    & " UNIT_MASTER_2.UM_Name AS Recp_UM,CAST(MRP_Num AS NUMERIC(18, 2)) AS MRP,CAST(sale_rate AS NUMERIC(18, 2)) AS SALERATE,HsnCode_vch AS HSNCODE, BarCode_vch AS BARCODE,ISNULL(LabelItemName_vch,'N/A')AS BrandName" _
