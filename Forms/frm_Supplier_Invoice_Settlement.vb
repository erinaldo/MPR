...
Public Class frm_Supplier_Invoice_Settlement
    ...
    Private Sub InitializeControls()
        clsObj.ComboBindForPayment(cmbCustomer, "Select ACC_ID,ACC_NAME from ACCOUNT_MASTER WHERE Is_Active=1 And AG_ID in (1,2,3,6,10,11,12) Order by ACC_NAME", "ACC_NAME", "ACC_ID", True)

        clsObj.ComboBindForPayment(cmbCustomerApprovePayment, "Select ACC_ID,ACC_NAME from ACCOUNT_MASTER WHERE Is_Active=1 And AG_ID in (1,2,3,6,10,11,12) Order by ACC_NAME", "ACC_NAME", "ACC_ID", True)

        clsObj.ComboBindForPayment(cmbCustomerSettleInvoice, "Select ACC_ID,ACC_NAME from ACCOUNT_MASTER WHERE Is_Active=1 And AG_ID in (1,2,3,6,10,11,12) Order by ACC_NAME", "ACC_NAME", "ACC_ID", True)
        ...
        clsObj.ComboBind(cmbBank, "SELECT ACC_ID,ACC_NAME FROM dbo.ACCOUNT_MASTER WHERE Is_Active=1 And AG_ID IN(" & AccountGroups.Bank_Accounts & "," & AccountGroups.Cash_in_hand & ")",
