EXEC sp_rename 'CustomerLedgerMaster', 'LedgerMaster'
EXEC sp_rename 'CustomerLedgerDetail', 'LedgerDetail'
EXEC sp_rename 'CustomerSettlementDetail', 'SettlementDetail'

----------------------------------------------------------------------------------------------------------------------------------
CREATE PROCEDURE Proc_Ledger_Insert
    (
...
--                from    CreditNote_Master
            ...
            EXECUTE Proc_Ledger_Insert @v_CN_CustId,
...
alter PROC Proc_UpdatePaymentStauts
...
------------------------------------------------------------------------------------------------------------------------------
  ALTER PROC ReverseInvoiceEntry 
    (
      @V_SI_ID NUMERIC(18, 0) ,
      @V_CUST_ID NUMERIC(18, 0)
    )
...
ALTER PROCEDURE Proc_CustomerSettlementDetail_Insert
    (
      @PaymentTransactionId NUMERIC(18, 0) ,
...
CREATE PROCEDURE Proc_SettlementDetail_Insert
    (
      @PaymentTransactionId NUMERIC(18, 0) ,
      @PaymentId NUMERIC(18, 0) ,
      @InvoiceId NUMERIC(18, 0) ,
