    ...
    BEGIN     
        ...
        IF @V_PROC_TYPE = 1
            BEGIN     
                ...
                SET @Remarks = 'Stock Out against Opening Item Id- '
    ...
    BEGIN    
        ...
        IF @V_PROC_TYPE = 2
            BEGIN      
                ...
                IF @amount > 0
                    BEGIN    
                        EXECUTE Proc_Ledger_Insert 10073, 0, @amount, @Remarks,
                ...
                ELSE
                    BEGIN    
                        ...
                        EXECUTE Proc_Ledger_Insert 10073, @V_Item_Qty, 0,
...
AS  
    BEGIN    
        ...
        SET @Remarks = 'Stock Out against CreditNote No- ' + @V_CreditNote_Code  
            + CAST(@V_CreditNote_No AS VARCHAR(50))    
