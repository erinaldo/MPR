...
VALUES  ( '0030_04_August_2018_ITCEligibilityChanges' ,
          GETDATE()
        )
Go

ALTER TABLE MATERIAL_RECIEVED_WITHOUT_PO_MASTER ADD FK_ITCEligibility_ID  Numeric(18,0) NOT NULL DEFAULT 1
        ...
        IF @V_PROC_TYPE = 1  
            BEGIN                              
                ...
                VALUES  ( @V_Received_ID ,  
                          ...
                          @v_GROSS_AMOUNT ,  
                          @v_GST_AMOUNT ,  
                          ( ISNULL(@v_CESS_AMOUNT, 0) + ISNULL(@v_ACESS_AMOUNT,0) ) ,  
                          @v_NET_AMOUNT ,  
                          @v_MRN_TYPE ,  
                          @V_VAT_ON_EXICE ,  
                          0 ,  
                ...
                EXECUTE Proc_Ledger_Insert @V_Reference_ID, 0, @v_GROSS_AMOUNT, @Remarks,  
...
ALTER TABLE MATERIAL_RECEIVED_AGAINST_PO_MASTER ADD FK_ITCEligibility_ID  Numeric(18,0) NOT NULL DEFAULT 1
